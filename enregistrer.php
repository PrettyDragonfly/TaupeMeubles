...
if(isset($login)){
    ...
    $stmt->execute();
    $result = $stmt->get_result() or die("Impossible de créer un compte pour l'instant<br>");
...
if($ok === true){
    ...
    $stmt->bind_param("ssssssssisi", $login, $email, $pass_hash, $nom, $prenom, $date, $sexe, $adresse, $codepostal, $ville, $telephone);
    $stmt->execute();
